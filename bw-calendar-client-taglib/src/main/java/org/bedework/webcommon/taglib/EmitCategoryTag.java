 ...
 */
public class EmitCategoryTag extends NameScopePropertyTag {
  ...
  public int doEndTag() throws JspTagException {
    try {
      ...
      final var val = (BwCategory)getObject(false);

      final JspWriter out = pageContext.getOut();

      BwTagUtils.outCategory(out, getIndent(), getTagName(),
                             getFull(), val);
