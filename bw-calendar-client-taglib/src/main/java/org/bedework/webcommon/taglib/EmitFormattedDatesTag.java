 ...
 */
public class EmitFormattedDatesTag extends NameScopePropertyTag {
  ...
  public int doEndTag() throws JspTagException {
    try {
      ...
      final var val = (DateTimeFormatter)getObject(false);

      final JspWriter out = pageContext.getOut();

      BwTagUtils.outFormattedDate(out, getIndent(), getTagName(),
                                  val);
