...
/**
 * User: douglm Date: 10/3/17 Time: 14:07
 * 
 * A networked implementation of the Client which only allows readonly 
 * access.
 * 
 * NOTE: this is mostly a place holder and allows me to figure out
 * refactoring issues. This is not yet a working feature.
 */
public class RONetClientImpl implements Client {
   ...
   */
  public RONetClientImpl(final String id,
  ...
  protected RONetClientImpl(final String id) {
    this.id = id;
  ...
  public Client copy(final String id) throws CalFacadeException {
    final RONetClientImpl cl = new RONetClientImpl(id);
